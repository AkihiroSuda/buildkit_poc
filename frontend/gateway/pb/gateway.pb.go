...
type SolveRequest struct {
	...
	ImportCacheTypes map[string]string `protobuf:"bytes,12,rep,name=ImportCacheTypes" json:"ImportCacheTypes,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *SolveRequest) GetImportCacheTypes() map[string]string {
	if m != nil {
		return m.ImportCacheTypes
	}
	return nil
}
...
func (m *SolveRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ImportCacheTypes) > 0 {
		for k, _ := range m.ImportCacheTypes {
			dAtA[i] = 0x62
			i++
			v := m.ImportCacheTypes[k]
			mapSize := 1 + len(k) + sovGateway(uint64(len(k))) + 1 + len(v) + sovGateway(uint64(len(v)))
			i = encodeVarintGateway(dAtA, i, uint64(mapSize))
			dAtA[i] = 0xa
			i++
...
func (m *SolveRequest) Size() (n int) {
	...
	if len(m.ImportCacheTypes) > 0 {
		for k, v := range m.ImportCacheTypes {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovGateway(uint64(len(k))) + 1 + len(v) + sovGateway(uint64(len(v)))
			n += mapEntrySize + 1 + sovGateway(uint64(mapEntrySize))
...
func (m *SolveRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ImportCacheTypes", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ImportCacheTypes == nil {
				m.ImportCacheTypes = make(map[string]string)
			}
			var mapkey string
			var mapvalue string
			for iNdEx < postIndex {
			...
			m.ImportCacheTypes[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipGateway(dAtA[iNdEx:])
...
var fileDescriptorGateway = []byte{
	...
	,
}
