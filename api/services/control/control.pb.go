...
type CacheOptions struct {
	...
	// 4 is reserved for ImportAttrs
	ImportTypes map[string]string `protobuf:"bytes,5,rep,name=ImportTypes" json:"ImportTypes,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	ExportType  string            `protobuf:"bytes,6,opt,name=ExportType,proto3" json:"ExportType,omitempty"`
}
...
func (m *CacheOptions) GetImportTypes() map[string]string {
	if m != nil {
...
func (m *CacheOptions) GetExportType() string {
	if m != nil {
		return m.ExportType
	}
	return ""
...
func (m *CacheOptions) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ImportTypes) > 0 {
		for k, _ := range m.ImportTypes {
			dAtA[i] = 0x2a
			i++
			v := m.ImportTypes[k]
			mapSize := 1 + len(k) + sovControl(uint64(len(k))) + 1 + len(v) + sovControl(uint64(len(v)))
	...
	if len(m.ExportType) > 0 {
		dAtA[i] = 0x32
		i++
		i = encodeVarintControl(dAtA, i, uint64(len(m.ExportType)))
		i += copy(dAtA[i:], m.ExportType)
	}
	return i, nil
}
...
func (m *CacheOptions) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ImportTypes", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			mapkey := string(dAtA[iNdEx:postStringIndexmapkey])
			iNdEx = postStringIndexmapkey
			if m.ImportTypes == nil {
				m.ImportTypes = make(map[string]string)
			}
			if iNdEx < postIndex {
				var valuekey uint64
				for shift := uint(0); ; shift += 7 {
		...
		case 6:
			...
			m.ExportType = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipControl(dAtA[iNdEx:])
...
var fileDescriptorControl = []byte{
	...
	,
}
