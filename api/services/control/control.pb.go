...
type SolveRequest struct {
	...
	DefinitionMetadata *pb.Metadata      `protobuf:"bytes,8,opt,name=DefinitionMetadata" json:"DefinitionMetadata,omitempty"`
}
...
func (m *SolveRequest) GetDefinitionMetadata() *pb.Metadata {
	if m != nil {
		return m.DefinitionMetadata
	}
	return nil
}
...
func (m *SolveRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DefinitionMetadata != nil {
		dAtA[i] = 0x42
		i++
		i = encodeVarintControl(dAtA, i, uint64(m.DefinitionMetadata.Size()))
		n3, err := m.DefinitionMetadata.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n3
...
func (m *SolveRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DefinitionMetadata", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.DefinitionMetadata == nil {
				m.DefinitionMetadata = &pb.Metadata{}
			}
			if err := m.DefinitionMetadata.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorControl = []byte{
	...
	,
}
