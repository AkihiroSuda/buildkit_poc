...
type OpMetadata struct {
	...
	WorkerConstraint *WorkerConstraint `protobuf:"bytes,2,opt,name=worker_constraint,json=workerConstraint" json:"worker_constraint,omitempty"`
}
...
func (m *WorkerConstraint) GetWorkerName() string {
	if m != nil {
		return m.WorkerName
	}
	return ""
...
func (m *WorkerConstraint) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.WorkerName) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintOps(dAtA, i, uint64(len(m.WorkerName)))
		i += copy(dAtA[i:], m.WorkerName)
	}
	return i, nil
}
...
var fileDescriptorOps = []byte{
	...
	,
}
