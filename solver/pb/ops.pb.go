...
type Metadata struct {
	...
	Entries map[github_com_opencontainers_go_digest.Digest]MetadataEntry `protobuf:"bytes,1,rep,name=entries,castkey=github.com/opencontainers/go-digest.Digest" json:"entries" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
}

func (m *Metadata) Reset()                    { *m = Metadata{} }
func (m *Metadata) String() string            { return proto.CompactTextString(m) }
func (*Metadata) ProtoMessage()               {}
func (*Metadata) Descriptor() ([]byte, []int) { return fileDescriptorOps, []int{10} }

func (m *Metadata) GetEntries() map[github_com_opencontainers_go_digest.Digest]MetadataEntry {
	if m != nil {
		return m.Entries
	}
	return nil
...
func (*MetadataEntry) Descriptor() ([]byte, []int) { return fileDescriptorOps, []int{11} }

func (m *MetadataEntry) GetIgnoreCache() bool {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*MetadataEntry)(nil), "pb.MetadataEntry")
}
...
func (m *MetadataEntry) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *MetadataEntry) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *MetadataEntry) Size() (n int) {
	var l int
	_ = l
	if m.IgnoreCache {
		n += 2
...
func (m *Metadata) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			iNdEx = postStringIndexmapkey
			if m.Entries == nil {
				m.Entries = make(map[github_com_opencontainers_go_digest.Digest]MetadataEntry)
			}
			if iNdEx < postIndex {
				var valuekey uint64
				for shift := uint(0); ; shift += 7 {
				...
				mapvalue := &MetadataEntry{}
				if err := mapvalue.Unmarshal(dAtA[iNdEx:postmsgIndex]); err != nil {
					return err
				}
				iNdEx = postmsgIndex
				m.Entries[github_com_opencontainers_go_digest.Digest(mapkey)] = *mapvalue
			} else {
				var mapvalue MetadataEntry
				m.Entries[github_com_opencontainers_go_digest.Digest(mapkey)] = mapvalue
			}
			iNdEx = postIndex
		default:
...
func (m *MetadataEntry) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MetadataEntry: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MetadataEntry: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
var fileDescriptorOps = []byte{
	...
	,
}
