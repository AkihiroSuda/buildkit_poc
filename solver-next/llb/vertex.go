...
func Load(def *llbpb.Definition, opts ...LoadOpt) (solver.Edge, error) {
	return loadLLB(def, func(dgst digest.Digest, pbOp *llbpb.Op, load func(digest.Digest) (solver.Vertex, error)) (solver.Vertex, error) {
...
func newVertex(dgst digest.Digest, op *llbpb.Op, opMeta *llbpb.OpMetadata, load func(digest.Digest) (solver.Vertex, error), opts ...LoadOpt) (*vertex, error) {
...
func loadLLB(def *llbpb.Definition, fn func(digest.Digest, *llbpb.Op, func(digest.Digest) (solver.Vertex, error)) (solver.Vertex, error)) (solver.Edge, error) {
	if len(def.Def) == 0 {
		return solver.Edge{}, errors.New("invalid empty definition")
	}

	allOps := make(map[digest.Digest]*llbpb.Op)
...
func llbOpName(op *llbpb.Op) string {
